...
homo_pairs_rot = np.load('../../data/baseline_rot.npy')
lumo_pairs_rot = np.load('../../data/baseline_rot.npy')
...
for i in ratio:
    ...
    'learning_rate': 0.0008*(1-i), 'decay_rate':0.95, 'decay_per_steps':1000, 'save_step':1000, 'drop_rate':0, 'save_path':'./trained_model/rot/nat_dimer_baseline_trans_%d'%len(train_homo_),\
    ...
    print('./trained_model/rot/nat_dimer_homo_trans_%d'%len(train_homo_))
