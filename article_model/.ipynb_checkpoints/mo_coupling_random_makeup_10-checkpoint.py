...
for i in ratio:
    ...
    'learning_rate': 0.0008*(1-i), 'decay_rate':0.95, 'decay_per_steps':1000, 'save_step':1000, 'drop_rate':0, 'save_path':'./trained_model2/trans/nat_dimer_homo_trans_%d'%len(train_homo_),\
    ...
    'learning_rate': 0.0008*(1-i), 'decay_rate':0.95, 'decay_per_steps':1000, 'save_step':1000, 'drop_rate':0, 'save_path':'./trained_model2/trans/nat_dimer_lumo_trans_%d'%len(train_lumo_),\
    'seed':None, 'debug_traj':False, 'pre_trained_path':None}
